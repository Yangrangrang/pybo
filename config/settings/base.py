...
BASE_DIR = Path(__file__).resolve().parent.parent.parent   # 기본 위치
...
SECRET_KEY = 'django-insecure-j-(icxrui93eqkq-j$(o-2vtfe=mx9er64b$c#0z9c3#le7hbd'
...
STATICFILES_DIRS = [
    BASE_DIR / 'static' # BASE_DIR = mysite
]
